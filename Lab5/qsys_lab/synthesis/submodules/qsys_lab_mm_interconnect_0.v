...
`timescale 1 ps / 1 ps
module qsys_lab_mm_interconnect_0 (
	...
	wire   [29:0] sram_s1_agent_m0_address;                          // SRAM_s1_agent:m0_address -> SRAM_s1_translator:uav_address
	...
	wire  [123:0] sram_s1_agent_rf_source_data;                      // SRAM_s1_agent:rf_source_data -> SRAM_s1_agent_rsp_fifo:in_data
	...
	wire  [123:0] sram_s1_agent_rsp_fifo_out_data;                   // SRAM_s1_agent_rsp_fifo:out_data -> SRAM_s1_agent:rf_sink_data
	...
	wire          sram_s1_agent_rp_valid;                            // SRAM_s1_agent:rp_valid -> router_002:sink_valid
	wire  [122:0] sram_s1_agent_rp_data;                             // SRAM_s1_agent:rp_data -> router_002:sink_data
	wire          sram_s1_agent_rp_ready;                            // router_002:sink_ready -> SRAM_s1_agent:rp_ready
	wire          sram_s1_agent_rp_startofpacket;                    // SRAM_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          sram_s1_agent_rp_endofpacket;                      // SRAM_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	wire          sram_s1_burst_adapter_source0_valid;               // SRAM_s1_burst_adapter:source0_valid -> SRAM_s1_agent:cp_valid
	wire  [122:0] sram_s1_burst_adapter_source0_data;                // SRAM_s1_burst_adapter:source0_data -> SRAM_s1_agent:cp_data
	wire          sram_s1_burst_adapter_source0_ready;               // SRAM_s1_agent:cp_ready -> SRAM_s1_burst_adapter:source0_ready
	wire    [1:0] sram_s1_burst_adapter_source0_channel;             // SRAM_s1_burst_adapter:source0_channel -> SRAM_s1_agent:cp_channel
	...
	wire          router_002_src_valid;                              // router_002:src_valid -> SRAM_s1_rsp_width_adapter:in_valid
	wire  [122:0] router_002_src_data;                               // router_002:src_data -> SRAM_s1_rsp_width_adapter:in_data
	wire          router_002_src_ready;                              // SRAM_s1_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                            // router_002:src_channel -> SRAM_s1_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                      // router_002:src_startofpacket -> SRAM_s1_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                        // router_002:src_endofpacket -> SRAM_s1_rsp_width_adapter:in_endofpacket
	wire          sram_s1_rsp_width_adapter_src_valid;               // SRAM_s1_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [158:0] sram_s1_rsp_width_adapter_src_data;                // SRAM_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          sram_s1_rsp_width_adapter_src_ready;               // rsp_demux:sink_ready -> SRAM_s1_rsp_width_adapter:out_ready
	wire    [1:0] sram_s1_rsp_width_adapter_src_channel;             // SRAM_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          sram_s1_rsp_width_adapter_src_startofpacket;       // SRAM_s1_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          sram_s1_rsp_width_adapter_src_endofpacket;         // SRAM_s1_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          cmd_mux_src_valid;                                 // cmd_mux:src_valid -> SRAM_s1_cmd_width_adapter:in_valid
	wire  [158:0] cmd_mux_src_data;                                  // cmd_mux:src_data -> SRAM_s1_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                 // SRAM_s1_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                               // cmd_mux:src_channel -> SRAM_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                         // cmd_mux:src_startofpacket -> SRAM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                           // cmd_mux:src_endofpacket -> SRAM_s1_cmd_width_adapter:in_endofpacket
	wire          sram_s1_cmd_width_adapter_src_valid;               // SRAM_s1_cmd_width_adapter:out_valid -> SRAM_s1_burst_adapter:sink0_valid
	wire  [122:0] sram_s1_cmd_width_adapter_src_data;                // SRAM_s1_cmd_width_adapter:out_data -> SRAM_s1_burst_adapter:sink0_data
	wire          sram_s1_cmd_width_adapter_src_ready;               // SRAM_s1_burst_adapter:sink0_ready -> SRAM_s1_cmd_width_adapter:out_ready
	wire    [1:0] sram_s1_cmd_width_adapter_src_channel;             // SRAM_s1_cmd_width_adapter:out_channel -> SRAM_s1_burst_adapter:sink0_channel
	wire          sram_s1_cmd_width_adapter_src_startofpacket;       // SRAM_s1_cmd_width_adapter:out_startofpacket -> SRAM_s1_burst_adapter:sink0_startofpacket
	wire          sram_s1_cmd_width_adapter_src_endofpacket;         // SRAM_s1_cmd_width_adapter:out_endofpacket -> SRAM_s1_burst_adapter:sink0_endofpacket
	wire          sram_s1_agent_rdata_fifo_out_valid;                // SRAM_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] sram_s1_agent_rdata_fifo_out_data;                 // SRAM_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          sram_s1_agent_rdata_fifo_out_ready;                // avalon_st_adapter:in_0_ready -> SRAM_s1_agent_rdata_fifo:out_ready
	...
	qsys_lab_mm_interconnect_0_router router (
	...
	qsys_lab_mm_interconnect_0_router router_001 (
	...
	qsys_lab_mm_interconnect_0_router_002 router_002 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (SRAM_reset1_reset_bridge_in_reset_reset),     // cr0_reset.reset
		.sink0_valid           (sram_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (sram_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (sram_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (sram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (sram_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (sram_s1_cmd_width_adapter_src_ready),         //          .ready
	...
	qsys_lab_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_lab_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_lab_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (SRAM_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_lab_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (SRAM_reset1_reset_bridge_in_reset_reset),     // clk_reset.reset
		.sink_ready         (sram_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (sram_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (sram_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (sram_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (sram_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (sram_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	qsys_lab_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_lab_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (sram_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sram_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (sram_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (sram_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (sram_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sram_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (sram_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sram_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (sram_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (sram_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (sram_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                       // (terminated)
	);
